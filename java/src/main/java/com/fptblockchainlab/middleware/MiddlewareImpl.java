...
public class MiddlewareImpl implements IMiddleware {
    ...
    private lc.LCManagement lcManagement;
    ...
    public MiddlewareImpl() {
        ...
        this.lcManagement = lc.LCManagement.load(lcManagmentAddress, quorum, fastRawTransactionManager, contractGasProvider);
...
//        }
//        return orgDetails.component1() == fullOrgId;
//    }
     ...
     * @throws Exception
     */
    private void createSubOrgs(String subOrgFullId) throws NotParentOrgException, IOException, FailedTransactionExeception {
...
//                Đã có trong Contract đã check và throw
//                if (!transactionReceipt.isStatusOK()) {
//                    throw new FailedTransactionExeception(String.format("transaction %s failed with %s", transactionReceipt.getTransactionHash(), transactionReceipt.getRevertReason()));
//                }
    ...
    private void createDefaultRolesForOrg(String orgFullId) throws FailedTransactionExeception, IOException {
...
//        Đã check trong Contract và throw
//        if (!transactionReceipt.isStatusOK()) {
//            throw new FailedTransactionExeception(String.format("transaction %s failed with %s", transactionReceipt.getTransactionHash(), transactionReceipt.getRevertReason()));
//        }
    }
    ...
    public void suspendAdminSubOrg(String subOrgFullId, String adminAddress) throws FailedTransactionExeception, IOException {
        ...
        try{
            TransactionReceipt transactionReceipt = this.permissionInterface.updateAccountStatus(subOrgFullId, adminAddress, BigInteger.valueOf(BlcWalletStatus.SUSPENDING.getValue())).send();
        } catch (Exception e) {
            throw new IOException("failed to unwhitelist org", e);
        }
    }
